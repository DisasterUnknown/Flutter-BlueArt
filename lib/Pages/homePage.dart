                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: AssetImage(artProductList[index].imageURL),
                                        fit: BoxFit.cover,
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 1.0),
                                          child: Text("LKR ${artProductList[index].price}", style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
                                        ),
                                      ],
                                    ),
                                  ),
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Collectables", style: Theme.of(context).textTheme.titleLarge),
                      GestureDetector(
                        child: Text("See More > "),
                        onTap: () {
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      // Adding the img
                                      image: DecorationImage(
                                        image: AssetImage(figureProductList[index].imageURL),
                                        fit: BoxFit.cover,
                                        colorFilter: ColorFilter.mode(Colors.black.withAlpha(30), BlendMode.darken),
                                      ),
                                    ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.symmetric(horizontal: 1.0),
                                          child: Text("LKR ${figureProductList[index].price}", style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w500)),
                                        ),
                                      ],
                                    ),
                                  ),
